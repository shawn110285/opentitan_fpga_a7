...
HD_PWD='D:/cpu_vivado2019/opentitan/opentitan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_earlgrey_artys7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_earlgrey_artys7.tcl
